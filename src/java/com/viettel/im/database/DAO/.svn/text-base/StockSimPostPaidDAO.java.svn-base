...
import com.viettel.im.database.BO.StockSimPostPaid;
 ...
 * StockSimPostPaid entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.viettel.im.database.BO.StockSimPostPaid
 * @author MyEclipse Persistence Tools
 */

public class StockSimPostPaidDAO extends BaseDAOAction {
	private static final Log log = LogFactory.getLog(StockSimPostPaidDAO.class);
	// property constants
	...
	public void save(StockSimPostPaid transientInstance) {
		log.debug("saving StockSimPostPaid instance");
		try {
	...
	public void delete(StockSimPostPaid persistentInstance) {
		log.debug("deleting StockSimPostPaid instance");
		try {
	...
	public StockSimPostPaid findById(java.lang.Long id) {
		log.debug("getting StockSimPostPaid instance with id: " + id);
		try {
			StockSimPostPaid instance = (StockSimPostPaid) getSession().get(
					"com.viettel.im.database.BO.StockSimPostPaid", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(StockSimPostPaid instance) {
		log.debug("finding StockSimPostPaid instance by example");
		try {
			List results = getSession().createCriteria(
					"com.viettel.im.database.BO.StockSimPostPaid").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding StockSimPostPaid instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from StockSimPostPaid as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all StockSimPostPaid instances");
		try {
			String queryString = "from StockSimPostPaid";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public StockSimPostPaid merge(StockSimPostPaid detachedInstance) {
		log.debug("merging StockSimPostPaid instance");
		try {
			StockSimPostPaid result = (StockSimPostPaid) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(StockSimPostPaid instance) {
		log.debug("attaching dirty StockSimPostPaid instance");
		try {
	...
	public void attachClean(StockSimPostPaid instance) {
		log.debug("attaching clean StockSimPostPaid instance");
		try {
