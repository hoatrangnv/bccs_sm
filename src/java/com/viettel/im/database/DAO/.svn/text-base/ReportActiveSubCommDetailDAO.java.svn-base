...
public class ReportActiveSubCommDetailDAO extends BaseDAOAction {
    ...
    private final String REPORT_ACCOUNT_AGENT = "reportActiveSubCommDetail";
    ...
    public String reportActiveSubComm() throws Exception {
        ...
        if (Constant.OBJECT_TYPE_STAFF.equals(channelType.getObjectType())) {
            ...
            if (shopAgent == null) {
                ...
                checkVat = shopAgent.getCheckVAT();
            }
        }
...
//        }
        ...
        request.set(ReportConstant.REPORT_KIND, ReportConstant.IM_REPORT_ACTIVE_SUBSCRIBER_DETAIL);
