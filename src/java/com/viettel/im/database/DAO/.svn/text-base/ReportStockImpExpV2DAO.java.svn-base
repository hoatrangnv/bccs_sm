 ...
 * @author trungdh3_s
 */
public class ReportStockImpExpV2DAO extends BaseDAOAction {
    ...
    public String preparePage() throws Exception {
        ...
        pageForward = "reportStockExpV2Imp";
...
//            req.setAttribute(REQUEST_MESSAGE, "Phải chọn từ ngày đến ngày trong cùng một tháng");
            ...
            request.set(ReportConstant.REPORT_KIND, ReportConstant.IM_REPORT_STOCK_IMP_EXP_V2);
