 ...
 *
 */
public class ReportRevenueOfflineDAO extends BaseDAOAction {
    ...
    public String reportRevenue() throws Exception {
        ...
        request.set("REPORT_INCLUDE_POINT_OF_SALE", reportIncludePointOfSale);
        ...
        if (stockTypeId != null && stockModelId > 0) {
        ...
        request.set(ReportConstant.REPORT_KIND, ReportConstant.IM_REPORT_REVENUE_OFFLINE);
...
//        }
        ...
        if (response != null
                ...
                && !"".equals(response.get(ReportConstant.RESULT_FILE).toString())) {
            DownloadDAO downloadDAO = new DownloadDAO();
            req.setAttribute(REQUEST_REPORT_DESTROY_PATH, downloadDAO.getFileNameEncNew(response.get(ReportConstant.RESULT_FILE).toString(), req.getSession()));
...
//                listParameterStaff.add(Constant.CHANNEL_TYPE_STAFF);
                ...
                strQueryStaff.append("and a.channelTypeId in (select channelTypeId from ChannelType where objectType=? and isVtUnit = ?) ");
