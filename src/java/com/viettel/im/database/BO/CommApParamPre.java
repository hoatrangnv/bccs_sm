...
public class CommApParamPre implements java.io.Serializable {
	...
	/** default constructor */
	public CommApParamPre() {
	}

	/** minimal constructor */
        public CommApParamPre(String paramCode,String paramName) {		
		this.paramCode = paramCode;
		this.paramName = paramName;
	}
	public CommApParamPre(Long paramId, String paramType, String paramCode,
			String paramName) {
