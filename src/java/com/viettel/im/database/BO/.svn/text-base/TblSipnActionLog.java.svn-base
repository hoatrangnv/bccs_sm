 ...
 */
public class TblSipnActionLog implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public TblSipnActionLog() {
    }

    /** minimal constructor */
    public TblSipnActionLog(Long actionLogId) {
        this.actionLogId = actionLogId;
    }

    /** full constructor */
    public TblSipnActionLog(Long actionLogId, String isdn,
    ...
    public TblSipnActionLog(String actionUser, String actionIpAddress, Date actionTime, String oldValue, String newValue,
