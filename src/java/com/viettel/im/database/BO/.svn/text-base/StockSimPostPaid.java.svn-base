...
/**
 * StockSimPostPaid entity.
 * 
 * @author MyEclipse Persistence Tools
 */
public class StockSimPostPaid implements java.io.Serializable {
    ...
    /** default constructor */
    public StockSimPostPaid() {
    }

    /** minimal constructor */
    public StockSimPostPaid(Long id, String imsi) {
        this.id = id;
        this.imsi = imsi;
    }

    public StockSimPostPaid(Long id, Long stockModelId, String imsi, String iccid, String pin, String puk, String pin2, String puk2, String isdn, String hlrId, String simType, String aucStatus, Date aucRegDate, Date aucRemoveDate, Long hlrStatus, Date hlrRegDate, Date hlrRemoveDate, Long ownerId, Long ownerType, Long oldOwnerId, Long oldOwnerType, Long status, String adm1, String eki, String serial, Long stateId) {
        this.id = id;
