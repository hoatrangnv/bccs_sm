 ...
 */
public class TblSimeActionLog implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public TblSimeActionLog() {
    }

    /** minimal constructor */
    public TblSimeActionLog(Long actionLogId) {
        this.actionLogId = actionLogId;
    }

    /** full constructor */
    public TblSimeActionLog(Long actionLogId, String isdn,
    ...
    public TblSimeActionLog(String actionUser, String actionIpAddress, Date actionTime, String oldValue, String newValue,
