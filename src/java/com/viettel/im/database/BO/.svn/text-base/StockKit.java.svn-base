 ...
 * @author
 */
public class StockKit implements java.io.Serializable {
    ...
    /** minimal constructor */
    public StockKit(Long id, String imsi) {
        this.id = id;
        this.imsi = imsi;
    }

    /** full constructor */
    public StockKit(Long id, Long stockModelId, String imsi, String isdn,
            String iccid, String puk, String pin, String puk2, String pin2,
            String hlrId, String simType, String aucStatus, Date aucRegDate,
            Date aucRemoveDate, Long hlrStatus, Date hlrRegDate,
            Date hlrRemoveDate, Long ownerId, Long ownerType, Long oldOwnerId,
            Long oldOwnerType, Long status, Long checkDial, Long dialStatus) {
        this.id = id;
