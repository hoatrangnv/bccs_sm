...
public class VShopTree implements java.io.Serializable {

	// Fields

	private VShopTreeId id;
    private Long rootId;
	...
	/** full constructor */
	public VShopTree(VShopTreeId id) {
		this.id = id;
	}

	// Property accessors

	public VShopTreeId getId() {
		return this.id;
	}

	public void setId(VShopTreeId id) {
		this.id = id;
	}
