...
/**
 * StockSimPrePaid entity.
 * 
 * @author MyEclipse Persistence Tools
 */
public class StockSimPrePaid implements java.io.Serializable {
    ...
    /** default constructor */
    public StockSimPrePaid() {
    }

    /** minimal constructor */
    public StockSimPrePaid(Long id, String imsi) {
        this.id = id;
        this.imsi = imsi;
    }

    public StockSimPrePaid(String serial,Long stockModelId) {
    ...
    public StockSimPrePaid(Long id, Long stockModelId, String imsi, String iccid, String pin, String puk, String pin2, String puk2, String isdn, String hlrId, String simType, String aucStatus, Date aucRegDate, Date aucRemoveDate, Long hlrStatus, Date hlrRegDate, Date hlrRemoveDate, Long ownerId, Long ownerType, Long oldOwnerId, Long oldOwnerType, Long status, String adm1, String eki, String serial, Long stateId) {
        this.id = id;
        this.stockModelId = stockModelId;
        this.imsi = imsi;
        this.iccid = iccid;
