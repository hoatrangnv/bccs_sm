 ...
 */
public class VOldStockCard implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public VOldStockCard() {
    }

    /** minimal constructor */
    public VOldStockCard(Long id, String serial) {
        this.id = id;
        this.serial = serial;
    }

    /** full constructor */
    public VOldStockCard(Long id, Long stockModelId, String serial,
