 ...
 */
public class ViewStockCard implements java.io.Serializable {
    ...
    /** default constructor */
    public ViewStockCard() {
    }

    /** minimal constructor */
    public ViewStockCard(Long id, String serial) {
        this.id = id;
        this.serial = serial;
    }

    /** full constructor */
    public ViewStockCard(Long id, Long stockModelId, String serial,
            String cardType, String amountType, Long ownerId, Long ownerType,
            Date createDate, Date expiredDate, Long status, Long stateId) {
        this.id = id;
