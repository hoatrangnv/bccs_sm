 ...
 * @author MrSun
 */
public class SaleToAnyPayManagementForm {
    ...
    private String pColIdS;    //Id CTV
    private String pColCodeS;    //Ma CTV
    private String pColNameS;    //Ten CTV
    ...
    private Long[] pTransIdList;      //Danh sach ma giao dich duoc chon
    private  Long pReasonId;


    public SaleToAnyPayManagementForm() {
    }

    public String getPColCodeS() {
        return pColCodeS;
    }

    public void setPColCodeS(String pColCodeS) {
        this.pColCodeS = pColCodeS;
    }

    public String getPColIdS() {
        return pColIdS;
    }

    public void setPColIdS(String pColIdS) {
        this.pColIdS = pColIdS;
    }

    public String getPColNameS() {
        return pColNameS;
    }

    public void setPColNameS(String pColNameS) {
    ...
    public Long[] getPTransIdList() {
        return pTransIdList;
    }

    public void setPTransIdList(Long[] pTransIdList) {
