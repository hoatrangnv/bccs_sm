...
public class AccountAgentBean {
    ...
    private Double maxCreditNumber;
    private Double maxCreditValue;
    private Double creditTimeLimit;
    private Double minPayPerMonth;
    ...
    public Double getMaxCreditNumber() {
        return maxCreditNumber;
    }

    public void setMaxCreditNumber(Double maxCreditNumber) {
        this.maxCreditNumber = maxCreditNumber;
    }

    public Double getMaxCreditValue() {
        return maxCreditValue;
    }

    public void setMaxCreditValue(Double maxCreditValue) {
        this.maxCreditValue = maxCreditValue;
    }

    public Double getMinPayPerMonth() {
        return minPayPerMonth;
    }

    public void setMinPayPerMonth(Double minPayPerMonth) {
    ...
    public Long getCheckPayment() {
        return checkPayment;
    }

    public void setCheckPayment(Long checkPayment) {
