<%-- 
    ...
    Created on : Sep 16, 2016, 10:42:13 AM
...
<s:form action="StockTransMasterAgentAction" theme="simple" enctype="multipart/form-data"  method="POST" id="exportStockForm">
<s:token/>
            ...
            <tr>
                <td colspan="4" align="center" >
                    ...
                    <tags:submit formId="exportStockForm" confirm="false"
                                 ...
                                 value="MSG.find" preAction="StockTransMasterAgentAction!searchExpTransConfirm.do"/>
                </td>
            </tr>
        </table>
    ...
    <sx:div id="searchArea" theme="simple">
        <jsp:include page="ListSearchExportNoteConfirm.jsp"/>
        <jsp:include page="ExportNoteConfirmToMasterAgent.jsp"/>
    </sx:div>
