...
<s:token/>
        ...
        <table class="inputTbl6Col">
            <tr>
                ...
                <td class="text">
                    <s:textfield name="shopForm.shopCode" id="shopForm.shopCode"  maxlength="1000" cssClass="txtInputFull" readonly="true" />
                </td>
                <td class="label"><tags:label key="MSG.SAE.110" /></td>
                <td class="text">
                    <s:textfield name="shopForm.name" id="shopForm.name" maxlength="1000"  cssClass="txtInputFull" readonly="true"/>
                </td>
            </tr>
        </table>
       <div class="divHasBorder" style="margin-top:10px; padding:3px;">
            <%--<s:radio name="shopForm.searchType" id ="searchType"
                     list="#{'1':'Gán quyền', '2':'Gỡ Quyền'}"/>--%>
