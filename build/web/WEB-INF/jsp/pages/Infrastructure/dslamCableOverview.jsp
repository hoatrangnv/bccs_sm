    ...
    <tr>
        <td style="width:250px; vertical-align:top">
            <tags:imPanel title="MSG.items">
                ...
                <div align="left" style="width:250px; height:915px; overflow:scroll; margin-left:5px; margin-top:5px;">
                    <tags:treeAjax
                        actionParamName="nodeId"
                        getNodeAction="${contextPath}/dslamAction!getListDslamCableTree.do"
                        rootId="9_"
        ...
        <td style="vertical-align:top">
            <sx:div id="divDisplayInfo">
                <jsp:include page="dslamCable.jsp"/>
            </sx:div>
        </td>
    </tr>
</table>