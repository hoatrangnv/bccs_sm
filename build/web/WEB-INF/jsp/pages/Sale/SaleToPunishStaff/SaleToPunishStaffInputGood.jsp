<%-- 
    Document   : SaleToPunishStaffInputGood
    Created on : Dec 11, 2012, 6:05:50 PM
    Author     : trungdh3_s
--%>
...
<fieldset class="imFieldset">
    ...
    <div style="width:100%; height:400px; vertical-align:top">
        <table class="inputTbl2Col">
                ...
                <td  class="text">
                    ...
                    <s:if test="form.saleTransDetailForm == null || form.saleTransDetailForm.stockModelId == null ">
                        <tags:imSearch codeVariable="form.saleTransDetailForm.stockModelCode" nameVariable="form.saleTransDetailForm.stockModelName"
                                       ...
                                       searchClassName="com.viettel.im.database.DAO.SaleToPunishStaffDAO"
            ...
            <!--            trang thai hang-->
            <tr>
                <td class="label"><tags:label key="MSG.SAE.094" required="true"/></td>
                <td  class="text" colspan="2">
                    <s:if test="form.saleTransDetailForm == null || form.saleTransDetailForm.stockModelId == null ">
                        <tags:imSelect name="form.saleTransDetailForm.state"
                                       theme="simple"
                                       id="state"
                                       cssClass="txtInputFull"
        ...
        <div align="center">
            <s:if test="form.saleTransDetailForm == null || form.saleTransDetailForm.stockModelId == null ">
                <tags:submit id="addGoods"
                             ...
                             value="Add"
                             preAction="saleToPunishStaffAction!addGoods.do"
            ...
            <s:else>
                ...
                <tags:submit id="editGoods"
                             ...
                             targets="saleToPunishDetailArea"
                             value="Edit"
                             preAction="saleToPunishStaffAction!editGoods.do"
                             validateFunction="checkValidate()"/>
                <tags:submit id="cancelGoods"
                             ...
                             targets="saleToPunishDetailArea"
                             value="Cancel"
                             preAction="saleToPunishStaffAction!cancelEditGoods.do"/>
            </s:else>
        </div>
    </div>
</fieldset>
...
<script type="text/javascript" language="javascript">
    changeStockModel = function() {
        ...
        updateData('${contextPath}/saleToPunishStaffAction!updateListGoodsPrice.do?stockModelCode='+ stockModelCode);
    }
    ...
    checkValidate = function(){
        ...
        if(state.value==null || state.value ==''){
            $('displayResultMsg').innerHTML='<s:text name="E.100079"/>';
            state.focus();
            return false;
        }
