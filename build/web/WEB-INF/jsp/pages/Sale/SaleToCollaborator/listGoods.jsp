...
<script type="text/javascript" language="javascript">
    ...
    prepareEditGoods = function(stockModelId){
        gotoAction("saleToRetailDetailDiv",'${contextPath}/saleToRetailV2Action!prepareEditGoods.do?stockModelId='+ stockModelId + "&" + token.getTokenParamString());
    }
    deleteGoods = function(stockModelId){
        gotoAction("saleToRetailDetailDiv",'${contextPath}/saleToRetailV2Action!deleteGoods.do?stockModelId='+ stockModelId + "&" + token.getTokenParamString());
    }
