...
<s:token/>
    ...
    <tags:SearchTrans form="importStockForm" target="searchArea" type="imp_from_staff" action="importStockFromStaffAction!searchImpTrans.do?impType=fromStaff"/>
