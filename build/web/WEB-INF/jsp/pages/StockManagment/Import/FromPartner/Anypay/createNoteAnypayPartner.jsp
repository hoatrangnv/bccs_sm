...
<tags:imPanel title="partner.anypay.create.notes">
        ...
        <s:form action="anypayPartnerAction" theme="simple" enctype="multipart/form-data"  method="POST" id="searchStockForm">
            ...
            <div style="width:100%; margin-top: 5px; margin-bottom: 5px;" align="center">
                <tags:submit formId="searchStockForm"
                             ...
                             cssStyle="width: 80px;"
                             value="MSG.GOD.009"
                             preAction="anypayPartnerAction!searchCmdAnypayPartnerForNotes.do"/>
            </div>
    ...
    <sx:div id="divCreateImpNoteFromPartner">
        <jsp:include page="listCmdAnypayPartnerForNotes.jsp"/>
    </sx:div>
</tags:imPanel>
