    ...
    <table style="width:100%">
        <tr>
            <td style="vertical-align:top; width:50%">
                <tags:ExportStockCmd subForm="exportStockForm" shopRecType="shop_exp_to_senior" readOnly="true" disabled="true" viewOnly="true" height="210px"/>
            </td>
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <s:if test="exportStockForm.canPrint !=null && exportStockForm.canPrint==1">
                        <input type="button" value="${fn:escapeXml(imDef:imGetText('MSG.GOD.200'))}" disabled ="false"/>
                        <tags:submit id="print" confirm="true" confirmText="MSG.confirm.print.note" formId="exportStockForm" showLoadingText="true" targets="bodyContent"
                                     value="MSG.printNote"
                                     preAction="ExportStockSeniorAction!printExpNote.do?realExp=true"/>
                        <!--R499-->
                        <tags:submit id="printBBBG" confirm="true"  formId="exportStockForm" showLoadingText="true" targets="bodyContent"
                                     value="In BBBG Chi tiết"
                                     preAction="ExportStockSeniorAction!printExpNote.do?expDetail=1"/>
                    </s:if>
                    <s:else>
                        <tags:submit id="exp" confirm="true" confirmText="MSG.confirm.export.store" formId="exportStockForm" showLoadingText="true" targets="bodyContent"
                                     value="MSG.expStock"
                                     preAction="ExportStockSeniorAction!expStock.do"/>
...
<script>
    ...
    dojo.event.topic.subscribe("ExportStockForm/expStock", function(event, widget){
        widget.href = "ExportStockSeniorAction!expStock.do";
