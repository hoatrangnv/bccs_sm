...
<fieldset class="imFieldset">
    ...
    <div style="width:100%; height:200px; overflow:auto;">
        <display:table name="listConvertChannelByFile" id="tbllistConvertChannelByFile"
            ...
            <display:column escapeXml="true"  property="channelCode" title="${fn:escapeXml(imDef:imGetText('MES.CHL.074'))}" style="text-align:center" sortable="false" headerClass="tct"/>
            <display:column escapeXml="true"  property="channelType" title="${fn:escapeXml(imDef:imGetText('label.channel.type'))}" style="text-align:center" sortable="false" headerClass="tct"/>                        
        </display:table>
    </div>
</fieldset>
