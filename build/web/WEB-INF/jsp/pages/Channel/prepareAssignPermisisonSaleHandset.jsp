...
<s:form action="channelChangeStaffAction" theme="simple" method="post" id="channelForm">
    ...
    <tags:imPanel title="title.prepareAssignPermisisonSaleHandset.page">
        <div>
        ...
        <div align="center" style="padding-top:5px; padding-bottom:5px;">
            <tags:submit formId="channelForm"
                         ...
                         preAction="channelChangeStaffAction!viewChannelCodeBeforeAssignRole.do"/>
        </div>
        <div id="listStaff">
    ...
    <div align="center" style="padding-top:5px; padding-bottom:5px;">
        <tags:submit formId="channelForm"
                     ...
                     value="MES.CHL.180"
                     confirm="true"
                     confirmText="MES.CHL.168"
                     validateFunction="checkValidFile()"
                     preAction="channelChangeStaffAction!assignPermissionSaleHandsetDiscount.do"/>
    </div>
