<%-- 
    Document   : ReportActiveSubscriber
    Created on : Apr 22, 2010, 2:18:06 PM
    Author     : Vunt
--%>
...
<tags:imPanel title="MSG.criterion.report.create">
    ...
    <s:form action="reportActiveSubscriberAction" theme="simple" method="post" id="reportRevenueForm">
<s:token/>
    ...
    <div align="center" style="padding-top:5px; padding-bottom:5px;">
        <tags:submit formId="reportRevenueForm"
                     ...
                     preAction="reportActiveSubscriberAction!reportActiveSub.do"/>
    </div>
