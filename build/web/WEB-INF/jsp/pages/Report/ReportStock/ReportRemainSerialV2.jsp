...
<s:form method="POST" id="reportStockImpExpForm" action="reportStockSerialRemainAction" theme="simple" enctype="multipart/form-data" method="post">
            ...
            <tr>
                ...
                <td  class="text" >
                    <tags:imSelect name="reportStockImpExpForm.lever"
                                   ...
                                   list="2:L.100085,3:L.100086,4:L.100888,5:L.100087,6:L.100088"
                                   />  
            ...
            <tr>
                <td colspan="8" align="center" width="100%">
                    <tags:submit id="report" confirm="false" formId="reportStockImpExpForm" showLoadingText="true"  validateFunction="check()"
                                 targets="bodyContent" value="MSG.report" preAction="reportStockSerialRemainAction!exportStockRemailExpReport.do"/>
                </td>
            </tr>
            <tr>
                <td colspan="8" align="center"  width="100%">
