...
<script type="text/javascript">
    ...
    var intervalTime = '${pageScope.showProgressIntervalTime}';
    ...
    updateDataForProgressDiv = function() {
        //
        updateProgressDiv('${contextPath}/imProgressAction!updateProgressDiv.do?showProgressClass=${pageScope.showProgressClass}&showProgressMethod=${pageScope.showProgressMethod}'); //
    }
