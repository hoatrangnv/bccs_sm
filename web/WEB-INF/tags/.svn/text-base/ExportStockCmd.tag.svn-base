...
<tags:imPanel title="${fn:escapeXml(title)}">
    <div style="${fn:escapeXml(style)}">
        ...
        <!--        TrongLV: bo sung loai doi tuong ma NV xuat: shop? channel?-->
        <s:if test="#attr.shopRecType != null && #attr.shopRecType=='staff_exp_to_shop' ">
            <!--    xuat tra cua hang: khi chon hang hoa : check kho nv-->
            <s:hidden name="staff_export_type" id="staff_export_type" value="staff_export_shop"/>
        </s:if>
        <s:elseif test="#attr.shopRecType != null && #attr.shopRecType=='Collaborator' ">
            <!--    xuat dat coc cho ctv: khi chon hang hoa : check kho nv quan ly-->
            <s:hidden name="staff_export_type" id="staff_export_type" value="staff_export_channel"/>
        </s:elseif>
        <s:else>
        ...
        <table class="inputTbl4Col">
            ...
            <s:if test="#attr.shopRecType =='staff'">
                <tr>
                    <td class="label">
                        <tags:label key="MSG.GOD.156" required="${require}"/>
                        <!--                        Nhân viên nhận hàng-->
                        <!--                        $_{require}-->
                    </td>
                    <td  class="text" colspan="3">
            ...
            <s:else>
                <s:if test="#attr.shopRecType =='Collaborator'">
                    ...
                    <s:select theme="simple"  name="%{#attr.subForm+'.shopImportedId'}"
                              ...
                              headerKey="" headerValue="--Chọn kho nhận hàng--"
                    ...
                    <s:if test="#attr.disabled =='true'">
                        ...
                        <td class="label">
                            <tags:label key="MSG.GOD.157"/>
                            <!--                            Hình thức thanh toán-->
                        </td>
                        <td class="text">
                            <tags:imSelect name="${pageScope.subForm}.payMethodeid"
                                           id="${pageScope.subForm}.payMethodeid"
                                           cssClass="txtInputFull"
                                           theme="simple"
                ...
                <s:else>
                    <s:if test="#attr.shopRecType == 'staff_exp_to_shop' || #attr.shopRecType=='shop_exp_to_senior' ">
                        <tr>
                            ...
                            <td  class="text" colspan="3">
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="70%">
                                            <s:textfield theme="simple" name="%{#attr.subForm+'.shopImportedName'}" id="%{#attr.subForm+'.shopImportedName'}" cssClass="txtInputFull" readonly="true"/>
                                        </td>
                                    </tr>
                                </table>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td  class="text" colspan="3">
                                ...
                                <tags:imSearch codeVariable="${pageScope.subForm}.shopImportedCode" nameVariable="${pageScope.subForm}.shopImportedName"
                                               ...
                                               getNameMethod="getShopExportStockName"
                                               readOnly="${pageScope.readOnly}"/>
                            </td>
            ...
            <s:if test="#attr.shopRecType == null || #attr.shopRecType=='' || #attr.shopRecType=='shop_exp_to_senior' ">
                <tr>
                    <td  class="label">
                    ...
                    <td colspan="3"  class="text">
                        <tags:imSelect theme="simple"
                                       name="${fn:escapeXml(pageScope.subForm)}.channelTypeId"
                                       id="${fn:escapeXml(pageScope.subForm)}.channelTypeId"
                                       cssClass="txtInputFull"
                        ...
                        <%--<s:if test="#attr.disabled =='true'">
                            <s:hidden theme="simple"  name="%{#attr.subForm+'.channelTypeId'}" id="%{#attr.subForm+'.channelTypeId'}"/>
                        </s:if>--%>
                    </td>
                </tr>
            </s:if><s:elseif test="#attr.shopRecType == 'staff_exp_to_shop' ">
                <s:hidden theme="simple"  name="%{#attr.subForm+'.channelTypeId'}" id="%{#attr.subForm+'.channelTypeId'}"/>
            </s:elseif>
