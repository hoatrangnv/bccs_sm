<%-- 
    Document   : StockGoodsSaleMasterAgent
    Created on : Sep 9, 2016, 10:49:03 AM
    ...
    <tr>
        ...
        <td class="text" colspan="2">            
            ...
            <tags:imSelect name="saleToCollaboratorForm.telecomServiceId" theme="simple"
                           ...
                           listKey="telecomServiceId" listValue="telServiceName" value="1"/>
        </td>
    </tr>
    <tr>
        ...
        <td  class="text">
            ...
            <tags:imSearch codeVariable="saleToCollaboratorForm.stockModelCode" nameVariable="saleToCollaboratorForm.stockModelName"
                           ...
                           otherParam="saleToCollaboratorForm.typeOfSale;saleToCollaboratorForm.staffCode"
        ...
        <td  class="label" align="left">
            ...
            <s:url action="ViewStockDetailAction!prepareViewStockDetail" id="URLViewStock" encode="true" escapeAmp="false">
                ...
                <s:param name="ownerCode"><s:property value="saleToCollaboratorForm.staffCode"/></s:param>
...
<div align="center">
    <s:if test="#request.isEdit == false">
        <tags:submit targets="bodyContent" 
                     ...
                     cssStyle="width:80px;"
                     value="MSG.add"
                     preAction="saleToMasterAgentAction!addGoods.do"
                     confirm="false"
    ...
    <s:else>
        ...
        <tags:submit targets="bodyContent" 
                     ...
                     cssStyle="width:80px;"
                     value="MSG.SAE.033"
                     preAction="saleToMasterAgentAction!editGoods.do"
                     validateFunction="checkValidate();"
                     showLoadingText="true"/>
        ...
        <tags:submit targets="inputGoods" 
                     ...
                     cssStyle="width:80px;"
                     value="MSG.SAE.034"
                     preAction="saleToMasterAgentAction!cancelEditGoods.do"
                     showLoadingText="true"/>
    </s:else>
