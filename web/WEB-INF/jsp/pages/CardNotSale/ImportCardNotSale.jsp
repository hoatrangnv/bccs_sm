...
<tags:imPanel title="title.import.staff">
...
<script type="text/javascript">
                    ...
                    importFile = function() {
                        ...
                        var actionURL = "importDebitTypeAction!importFile.do";
                    ...
                    downloadPatternFile = function() {
                        window.open('${contextPath}/share/pattern/Import_debit.xls', '', 'toolbar=yes,scrollbars=yes');
                    }
