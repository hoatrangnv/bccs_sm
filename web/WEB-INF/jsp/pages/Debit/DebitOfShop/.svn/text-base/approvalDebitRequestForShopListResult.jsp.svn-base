...
<fieldset class="imFieldset">
    ...
    <div id="goodList" style="width:100%; vertical-align:top;height:280px " >
        <div style="height:270px;overflow:auto">
            ...
            <display:table targets="bodyContent" id="requestDebit" name="listDebitRequest" class="dataTable" cellpadding="1" cellspacing="1" requestURI="approvalDebitRequestForShopAction!pageNavigator.do" pagesize="20">
                ...
                <display:column escapeXml="false" title="${imDef:imGetText('lbl.duyet.yeu.cau')}" sortable="false" style="text-align:center;width:40px" headerClass="tct">
                    <s:if test="#attr.requestDebit.status == 1 || #attr.requestDebit.status == 3">
                        <div align="center" style="vertical-align:middle">
                            <s:url action="approvalDebitRequestForShopAction!viewDetail" id="URL">
                            ...
                            <sx:a targets="listDebitRequestDetailDiv" href="%{#URL}" cssClass="cursorHand" executeScripts="true" parseContent="true">
                                <img src="${contextPath}/share/img/accept_1.png" title="lbl.duyet.yeu.cau" alt="lbl.duyet.yeu.cau"/>
                            </sx:a>
                        </div>
                    </s:if>
                </display:column>                
