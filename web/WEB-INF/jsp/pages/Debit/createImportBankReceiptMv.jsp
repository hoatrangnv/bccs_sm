            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td class="text" colspan="7" style="width:80%">
                        <tags:imFileUpload name="form.clientFileName" id="form.clientFileName" serverFileName="form.serverFileName" cssStyle="width:500px;" impBankReceipt="true" extension="xls"/>
                    </td>
...
<script>
    goBack = function(){
        gotoAction("bodyContent", "${contextPath}/importBRMAction!preparePageIBRM.do", "form")
    }
