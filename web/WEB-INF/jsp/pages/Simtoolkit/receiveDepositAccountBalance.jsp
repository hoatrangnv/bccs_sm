<%-- 
    Document   : receiveDepositAccountBalance
    Created on : Jan 20, 2012, 4:15:07 PM
    Author     : TrongLV
--%>
...
<s:token/>
    ...
    <tags:imPanel title="MSG.SIK.250">
        ...
        <table class="inputTbl4Col" style="width:100%">
            ...
            <tr>
                <td class="label"><tags:label key="code"/></td>
                <td class="text">
            ...
            <tr>
                <td class="label"><tags:label key="reason" required="true"/></td>
                <td class="text">
        ...
        <div>
            <s:if test="accountBalanceForm.receiptId == null ">
                <input type="button" onclick="createReceipt();"  value="<s:property escapeJavaScript="true"  value="getText('MSG.SIK.088')"/>" style="width: 120px;"/>
...
<script language="javascript">
    ...
    createReceipt = function(){
        ...
        document.getElementById("accountBalanceForm").action="simtkManagmentAction!createReceiveDeposit.do";
    ...
    resetForm = function(){
        document.getElementById("accountBalanceForm").action="simtkManagmentAction!resetReceiveDeposit.do";
        document.getElementById("accountBalanceForm").submit();
    }
