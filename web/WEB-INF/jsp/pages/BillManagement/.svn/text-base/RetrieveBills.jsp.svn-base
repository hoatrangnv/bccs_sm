<%-- 
    Document   : RetrieveBills.jsp
    Created on : Feb 18, 2009, 10:51:45 AM
    Author     : TungTV
    Desc       : thu hoi hoa don chua su dung
--%>
...
<tags:imPanel title="MSG.recover.invoice.not.use">
    ...
    <s:form action="retrieveBillsAction" method="post" id="form" theme="simple">
<s:token/>
        ...
        <div class="divHasBorder">
                ...
                <tr>
                    ...
                    <td class="oddColumn">
                        <tags:imSearch codeVariable="form.ownerCode" nameVariable="form.ownerName"
                                       ...
                                       searchClassName="com.viettel.im.database.DAO.RetrieveBillsDAO"
            ...
            <div style="width:100%" align="center">
                <tags:submit targets="bodyContent" formId="form"
                             value="MSG.find"
                             cssStyle="width:80px;"
                             preAction="retrieveBillsAction!searchBills.do"
                             showLoadingText="true"
                             validateFunction="validateSearch()"/>
            </div>
        </div>
            <div style="width:100%" align="center">
            <jsp:include page="RetrieveBillsSearchResult.jsp"/>
        </div>
    </s:form>
</tags:imPanel>
...
//            $('displayResultMsgClient').innerHTML= '<s:property escapeJavaScript="true"  value="getError('assignChannelTypeForSerial.error.invalidShopCode')"/>';//$('message').innerHTML = "!!!Lỗi. Mã kho lấy số chỉ được chứa các ký tự A-Z, a-z, 0-9, _";
...
//            $('displayResultMsgClient').innerHTML= '<s:property escapeJavaScript="true"  value="getError('ERR.BIL.009')"/>';
            $('displayResultMsgClient').innerHTML= '<s:text name="ERR.BIL.009"/>';
