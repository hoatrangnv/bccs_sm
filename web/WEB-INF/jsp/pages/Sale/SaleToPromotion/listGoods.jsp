...
<script type="text/javascript" language="javascript">
    ...
    prepareEditGoods = function(stockModelId){
        gotoAction("detailDiv",'${contextPath}/saleToPromotionV2Action!prepareEditGoods.do?stockModelId='+ stockModelId + "&" + token.getTokenParamString());
    }
    deleteGoods = function(stockModelId){
        gotoAction("detailDiv",'${contextPath}/saleToPromotionV2Action!deleteGoods.do?stockModelId='+ stockModelId + "&" + token.getTokenParamString());
    }

     updateSerial = function() {
        gotoAction("detailDiv",'${contextPath}/saleToPromotionV2Action!refreshGoodsList.do' + "?" + token.getTokenParamString());
    }
