        ...
        <table class="inputTbl2Col">
            ...
            <s:if test="form.saleTransDetailForm == null || form.saleTransDetailForm.stockModelId == null ">
                <tags:imSearch codeVariable="form.saleTransDetailForm.stockModelCode" nameVariable="form.saleTransDetailForm.stockModelName"
                               ...
                               searchClassName="com.viettel.im.database.DAO.SaleToPromotionV2DAO" 
        ...
        <div align="center">
            <s:if test="form.saleTransDetailForm == null || form.saleTransDetailForm.stockModelId == null ">
                <tags:submit id="addGoods"
                             ...
                             targets="detailDiv"
                             value="Add"
                             preAction="saleToPromotionV2Action!addGoods.do"
            ...
            <s:else>               
                <input type="button" disabled value="<s:text name = "Add"/>" style="width:80px;">
                       ...
                       targets="detailDiv"
                       value="Edit"
                       preAction="saleToPromotionV2Action!editGoods.do"
                       validateFunction="checkValidate()"/>
                <tags:submit id="cancelGoods"
                             ...
                             targets="detailDiv"
                             value="Cancel"
                             preAction="saleToPromotionV2Action!cancelEditGoods.do"/>
            </s:else>
        </div>
    </div>
</fieldset>
...
<script type="text/javascript" language="javascript">
    changeStockModel = function() {
        ...
        updateData('${contextPath}/saleToPromotionV2Action!updateListGoodsPrice.do?stockModelCode='+ stockModelCode);
    }
