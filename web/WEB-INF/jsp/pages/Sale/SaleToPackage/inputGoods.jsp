            ...
            <tr>
                ...
                <td  class="text">
                    ...
                    <tags:imSearch codeVariable="saleTransForm.saleTransDetailForm.stockModelCode" nameVariable="saleTransForm.saleTransDetailForm.stockModelName"
                                   ...
                                   searchClassName="com.viettel.im.database.DAO.SaleToPackageDAO" 
        ...
        <div align="center">
            <s:if test="saleTransForm.saleTransDetailForm == null || saleTransForm.saleTransDetailForm.stockModelId == null ">
                <tags:submit id="addGoods"
                             ...
                             value="Add"
                             preAction="saleToPackageAction!addGoods.do"
            ...
            <s:else>               
                ...
                <tags:submit id="editGoods"
                             ...
                             targets="saleToRetailDetailDiv"
                             value="Edit"
                             preAction="saleToPackageAction!editGoods.do"
                             validateFunction="checkValidate()"/>
                <tags:submit id="cancelGoods"
                             ...
                             targets="saleToRetailDetailDiv"
                             value="Cancel"
                             preAction="saleToPackageAction!cancelEditGoods.do"/>
            </s:else>
        </div>
    </div>
</fieldset>
...
<script type="text/javascript" language="javascript">
    changeStockModel = function() {
        ...
        var reasonId = $('saleTransForm.reasonId').value;
        updateData('${contextPath}/saleToPackageAction!updateListModelPrice.do?stockModelCode='+ stockModelCode +'&reasonId=' + reasonId);
    }
