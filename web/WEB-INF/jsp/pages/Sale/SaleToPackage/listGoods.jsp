...
<script type="text/javascript" language="javascript">
    ...
    prepareEditGoods = function(stockModelId){
        ...
        gotoAction("saleToRetailDetailDiv",'${contextPath}/saleToPackageAction!prepareEditGoods.do?stockModelId='+ stockModelId + "&reasonId="+ reasonId + "&" + token.getTokenParamString());
    }
    
    deleteGoods = function(stockModelId){
        var reasonId = document.getElementById('saleTransForm.reasonId').value;
        gotoAction("saleToRetailDetailDiv",'${contextPath}/saleToPackageAction!deleteGoods.do?stockModelId='+ stockModelId + "&reasonId="+ reasonId + "&" + token.getTokenParamString());
    }

    updateSerial = function() {
        gotoAction("saleToRetailDetailDiv",'${contextPath}/saleToPackageAction!updateListGoods.do?' + token.getTokenParamString());
    }
