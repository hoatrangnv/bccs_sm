<%-- 
    Document   : saleToRetailV3
    Created on : Dec 26, 2012, 3:29:28 PM
    Author     : trungdh3_s
--%>
...
<tags:imPanel title="MSG.SAE.001">
    <s:form action="saleToRetailV3Action" theme="simple" method="post" id="form">
        <s:token/>
        ...
        <div align="center" id="saleToRetailDetailDiv">
            <jsp:include page="saleToRetailDetailV3.jsp"/>
        </div>
        <div align="center">
            <tags:submit confirm="true" confirmText="MSG.SAE.204"
                         ...
                         value="MSG.SAE.064" preAction="saleToRetailV3Action!save.do"/>
