                ...
                <div style="width:100%; height:320px; overflow:auto;">
                    <display:table name="lstSaleTrans" targets="searchResultArea" id="trans" pagesize="800" 
                        ...
                        <s:if test="#attr.trans.status==1">
                            ...
                            <display:column title="Clear deposit transaction" sortable="false" headerClass="tct" >
                                <input  id="saleTransId<s:property  value="%{#attr.trans_rowNum}"/>" name="depositId<s:property  value="%{#attr.trans_rowNum}"/>" placeholder="Enter depositId" style="text-align: center"/>
                                <s:url action="orderManagementAction!clearDepositTransaction" id="URL" encode="true" escapeAmp="false">
                                    <s:param name="tranferId" value="#attr.trans.bankTranferInfoId"/>
                                    <s:param name="depositId" value="depositId"/>
                                    <s:param name="rowNum" value="%{#attr.trans_rowNum}"/>
                                </s:url>
                                <sx:a targets="detailArea" href="%{#URL}" executeScripts="true" parseContent="true" errorNotifyTopics="errorAction">
                                    <s:property escapeJavaScript="true"  value="getText('MSG.ORDER.CLEAR')"/>
                            ...
                            <display:column title="Clear sale float transaction" sortable="false" headerClass="tct" >
                                <input  id="paymentId<s:property  value="%{#attr.trans_rowNum}"/>" name="saleFloatId<s:property  value="%{#attr.trans_rowNum}"/>" placeholder="Enter saleFloatId" style="text-align: center" />
                                <s:url action="orderManagementAction!clearSaleFloatTransaction" id="URL" encode="true" escapeAmp="false">
                                    <s:param name="tranferId" value="#attr.trans.bankTranferInfoId"/>
                                    <s:param name="saleFloatId" value="saleFloatId"/>
                                    <s:param name="rowNum" value="%{#attr.trans_rowNum}"/>
                                </s:url>
                                <sx:a targets="detailArea" href="%{#URL}" executeScripts="true" parseContent="true" errorNotifyTopics="errorAction">
                                    <s:property escapeJavaScript="true"  value="getText('MSG.ORDER.CLEAR')"/>
