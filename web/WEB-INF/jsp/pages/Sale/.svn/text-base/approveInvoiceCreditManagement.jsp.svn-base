...
<tags:imPanel title="MSG.SAE.184">
    <s:form action="ApproveInvoiceCreditManagementAction" theme="simple" method="post" id="form">
        <!-- hien thi message -->
        <div>
        ...
        <div class="divHasBorder">
            <table class="inputTbl6Col">
                ...
                <tr>
                    ...
                    <td class="label"><tags:label key="MSG.SAE.1891"/></td>
                    <td class="text">
                        <tags:imSelect name="form.approveStatusSearch"
                                       id="approveStatusSearch"
                                       cssClass="txtInputFull"
                                       list="1:MSG.requested, 2:MSG.approved"
                                       headerKey="" headerValue="MSG.SAE.1901"/>
                    </td>
                </tr>
            </table>
            ...
            <div style="width:100%" align="center">
                <tags:submit targets="bodyContent"
                             formId="form"
                             value="MSG.SAE.138"
                             preAction="ApproveInvoiceCreditManagementAction!searchInvoice.do"
        ...
        <jsp:include page="approveInvoiceCreditSaleTransList.jsp"/>
