...
<s:token/>
    ...
    <tags:imPanel title="MES.CHL.163">
        <div>
            <table class="inputTbl4Col">
                <tr>
                    <td colspan="4" align="center">                        
                        <%--a href="${contextPath}/share/pattern/OnOffStaffByFile.xls">${fn:escapeXml(imDef:imGetText('MES.CHL.164'))}</a--%>
                        <a href="${contextPath}/share/pattern/changeStatusForStaff.xls">${fn:escapeXml(imDef:imGetText('MES.CHL.164'))}</a>
                    </td>
                </tr>
                <tr id="trImpByFile">
        ...
        <div align="center" style="padding-top:5px; padding-bottom:5px;">
            <tags:submit formId="channelForm"
                         ...
                         preAction="channelChangeStaffAction!viewFileOnOff.do"/>
        </div>
        <div id="listStaff">
            <jsp:include page="ListStaffOnOff.jsp"/>
        </div>
    </tags:imPanel>
    ...
    <div align="center" style="padding-top:5px; padding-bottom:5px;">
        <tags:submit formId="channelForm"
                     ...
                     value="MES.CHL.165"
                     confirm="true"
                     confirmText="MES.CHL.166"
                     validateFunction="checkValidFile()"
                     preAction="channelChangeStaffAction!onOffStaffByFile.do"/>
    </div>
