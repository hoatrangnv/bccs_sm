...
<s:form action="channelChangeStaffAction" theme="simple" method="post" id="channelForm">
    ...
    <tags:imPanel title="title.prepareRemovePermisisonSaleHandset.page">
        <div>
            <table class="inputTbl4Col">
                <tr>
                    <td colspan="4" align="center">                        
                        <a href="${contextPath}/share/pattern/assignPermisisonSaleHandset.xls">${fn:escapeXml(imDef:imGetText('MES.CHL.164'))}</a>
                    </td>
                </tr>
                <tr id="trImpByFile">
        ...
        <div class="divHasBorder" style="margin-top:10px; padding:3px;">
            <tags:imRadio name="channelForm.changeType" id="changeType"
                          list="1:MES.CHL.182,2:MES.CHL.183"/>
        </div>
        <div align="center" style="padding-top:5px; padding-bottom:5px;">
            <tags:submit formId="channelForm"
                         ...
                         preAction="channelChangeStaffAction!viewChannelCodeBeforeRemoveRole.do"/>
        </div>
        <div id="listStaff">
            <jsp:include page="ListChannelAssignPermisison.jsp"/>
        </div>
    </tags:imPanel>
    ...
    <div align="center" style="padding-top:5px; padding-bottom:5px;">
        <tags:submit formId="channelForm"
                     ...
                     value="MES.CHL.181"
                     confirm="true"
                     confirmText="MES.CHL.169"
                     validateFunction="checkValidFile()"
                     preAction="channelChangeStaffAction!removePermissionSaleHandsetDiscount.do"/>
    </div>
