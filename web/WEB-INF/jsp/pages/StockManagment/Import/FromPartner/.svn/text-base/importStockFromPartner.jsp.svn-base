...
<%--
    Document   : ImportStockFromPartner
    Created on : Feb 17, 2009, 10:51:45 AM
    Author     : tamdt1
    Desc       : nhap hang tu doi tac
--%>
...
<s:token/>
        ...
        <div class="divHasBorder">
            <table class="inputTbl6Col">
                ...
                <tr>
                    ...
                    <!--   tannh20180327: fig chi cho chon Scratch Card theo yeu cau cua anh TienHV-->
                        ...
                        <select onchange="changeStockType(this.value)" style="width:100%;font-family:Tahoma;font-size:13px;border-style: ridge; "
                                 name="importStockForm.stockTypeId" id="stockTypeId">
                            <option value="0">-- Select type of Goods --</option> 
                            <option value="6">Scratch Card</option>
                        </select> 
                    </td>
                </tr>
                <tr>
                ...
                <tr id="trImpByFile">
                    ...
                    <td class="text" colspan="7" style="width:90%">
                        <tags:imFileUpload 
                            ...
                            serverFileName="importStockForm.serverFileName" cssStyle="width:500px;" extension="xls;txt"/>
                    </td>
                </tr>
                <tr id="trImpBySerial">
        ...
        <span id="btnImportFromPartner" align="center">
            <tags:submit formId="importStockForm"
                         ...
                         preAction="importFromPartnerAction!importFromPartner.do"
        ...
        <tags:submit formId="importStockForm"
                     ...
                     preAction="importFromPartnerAction!printImpNote.do"/>
        <tags:submit formId="importStockForm"
                     showLoadingText="true"
                     targets="bodyContent"
                     value="MSG.print.export.note"
                     preAction="importFromPartnerAction!printExpNote.do"/>
