...
<sx:div id="divListGoods">
    ...
    <div>
        <tags:displayResult property="message" id="message" propertyValue="listMessageParam" type="key"/>
        ...
        <tr>
            <td style="width:40%; vertical-align:top">
                <fieldset class="imFieldset">
                    <legend>${imDef:imGetText('MSG.stock.detail.goods')}</legend>
                    <div style="width:100%; height:300px; overflow:auto;">
                        <s:form action="anypayPartnerAction" theme="simple" enctype="multipart/form-data"  method="POST" id="goodsForm">
                            ...
                            <table class="inputTbl2Col">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <s:textfield name="goodsForm.quantity" id="quantity" cssClass="txtInputFull" maxLength="10" theme="simple" onkeyup="textFieldNF(this);" />
                                    </td>
                                </tr>
                                <tr>
                                    <!-- ghi chu -->
                                    ...
                                    <td>
                                        <s:textfield maxlength="250" name="goodsForm.note" id="note" cssClass="txtInputFull"  theme="simple"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <tags:submit id="btnAddGoods"
                                                     ...
                                                     value="MSG.GOD.019"
                                                     preAction="anypayPartnerAction!addGoodsDestroy.do"
                                        ...
                                        <input type="button"
                                               onclick="viewStockDetail('<s:property value="#attr.URLViewStock"/>')"
                ...
                <fieldset class="imFieldset">
                    ...
                    <div style="width:100%; height:300px; overflow:auto;">
                        <display:table id="tblListGoods" name="listGoods" class="dataTable" requestURI="javascript: void(0)" cellpadding="1" cellspacing="1">
                            ...
                            <display:column title="${imDef:imGetText('MSG.GOD.021')}" sortable="false" headerClass="tct" style="text-align:center;">
                                <s:url action="anypayPartnerAction!delGoodsDestroy" id="URL1" escapeAmp="false">
                                    <s:token/>
                                ...
                                <sx:a targets="divListGoods" href="%{#URL1}" cssClass="cursorHand" executeScripts="true" parseContent="true">
                                    <img src="${contextPath}/share/img/delete_icon.jpg" title="${imDef:imGetText('MSG.SAE.042')}" 
                                         alt="${imDef:imGetText('MSG.SAE.042')}"/>
                                </sx:a>
                            </display:column>
                        </display:table>
                    </div>
...
<script>
    ...
    checkValidGoodsForm = function() {
        ...
        if(!isInteger(trim(quantity))) {
            $('message' ).innerHTML = '<s:text name="ERR.STK.118"/>';
            $('quantity').select();
            $('quantity').focus();
            return false;
        }
