            ...
            <display:column title="${fn:escapeXml(imDef:imGetText('MSG.GOD.207'))}" sortable="false" headerClass="tct">
                <div align="center">
                    <s:if test="#attr.trans.stockTransStatus ==3"> <!-- chi nhung giao dịch đã xuat kho moi duoc lap lenh nhap -->
                        <s:url action="importStockFromStaffAction!prepareCreateImpStockFromStaff" id="URL" encode="true" escapeAmp="false">
...
<!--                            Nhập kho-->
                        ...
                        <s:url action="importStockFromStaffAction!rejectImpStockFromStaff" id="URLReject" encode="true" escapeAmp="false">
