            ...
            <td colspan="2" align="center">
                <s:if test="exportStockForm.canPrint !=null && exportStockForm.canPrint ==1">
                    ...
                    <tags:submit id="exp" formId="exportStockForm" showLoadingText="true" targets="searchArea"
                                 ...
                                 preAction="exportStockToStaffAction!printExpNote.do?type=expToStaff"/>
                    <tags:submit id="exp" formId="exportStockForm" showLoadingText="true" targets="searchArea"
                                 value="MSG.print.export"
                                 preAction="exportStockToStaffAction!printExpNote.do?type=expToStaff&expDetail=1"/>
                </s:if>
                <s:else>
...
<script>
    ...
    updateSerial = function (){
        gotoAction("searchArea", "exportStockToStaffAction!refreshListGoods.do","exportStockForm");
    }
