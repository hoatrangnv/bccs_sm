<%-- 
    Document   : ExportStockToRecover
    Created on : Sep 26, 2009, 10:53:31 AM
    Author     : User
--%>
...
<s:token/>
    ...
    <tags:SearchTransRecover form="exportStockForm" target="searchArea" type="exp_to_senior" action="ExportStockSeniorAction!searchExpTransRecover.do"/>
