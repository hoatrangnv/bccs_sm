...
<%-- 
    Document   : ExportStockToUnderlyingCmdAgentDeposit
    Created on : Nov 25, 2010, 2:34:26 PM
    Author     : vunt
--%>
...
<div id="inputGoods">
    <jsp:include page="../../Common/GoodsAgentDeposit.jsp"/>
</div>
<div style="width:100%" align="center">
    <s:if test="exportStockForm.actionId == null">
        <tags:submit id="exp" formId="ExportStockForm" confirm="true" confirmText="MSG.confirm.create.cmd.exp.store" showLoadingText="true" targets="bodyContent"
                 ...
                 preAction="ExportStockUnderlyingAction!createDeliverCmdAgentDeposit.do"/>
    </s:if>
    <s:else>
    ...
    <s:if test="exportStockForm.actionId !=null">
        ...
        <tags:submit id="print" formId="ExportStockForm" showLoadingText="true" targets="bodyContent"
                     value="MSG.printExportCmd"  preAction="ExportStockUnderlyingAction!printExpCmdAgentDeposit.do"/>
    </s:if>
    <s:else>
    ...
    <tags:submit id="reset" formId="ExportStockForm" showLoadingText="false" targets="bodyContent"
                 value="MSG.reset" preAction="ExportStockUnderlyingAction!clearFormAgentDeposit.do"/>
