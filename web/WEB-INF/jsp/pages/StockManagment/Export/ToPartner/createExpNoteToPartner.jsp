...
<tags:imPanel title="title.createExpNoteToPartner.page">
...
<s:token/>
            ...
            <div style="width:100%; margin-top: 5px; margin-bottom: 5px;" align="center">
                <tags:submit formId="searchStockForm"
                             ...
                             cssStyle="width: 80px;"
                             value="MSG.GOD.009"
                             preAction="createExpNoteToPartnerAction!searchExpCmdToPartner.do"/>
            </div>
    ...
    <sx:div id="divCreateExpNoteToPartner">
        <jsp:include page="listExpCmdToPartner.jsp"/>
    </sx:div>
