<%-- 
    Document   : ReportAccountAgentBL
    Created on : Apr 20, 2010, 9:51:08 AM
    Author     : User
--%>
...
<tags:imPanel title="MSG.criterion.report.create">
    ...
    <s:form action="reportAccountAgentBLAction" theme="simple" method="post" id="reportRevenueForm">
<s:token/>
    ...
    <div align="center" style="padding-top:5px; padding-bottom:5px;">
        <tags:submit formId="reportRevenueForm"
                     ...
                     preAction="reportAccountAgentBLAction!reportSubscriber.do"/>
    </div>
