<%-- 
    Document   : ReportActiveSubCommDetail
    Created on : May 31, 2010, 9:41:53 AM
    Author     : Vunt
--%>
...
<tags:imPanel title="MSG.criterion.report.create">
    ...
    <s:form action="reportActiveSubCommDetailAction" theme="simple" method="post" id="reportRevenueForm">
<s:token/>
                ...
                <tr>
                    ...
                    <td>
                        <%--<s:select name="reportRevenueForm.channelTypeId"
                                  ...
                                  theme="simple"
                                  headerKey="MSG.account.status" headerValue="MSG.account.status"
    ...
    <div align="center" style="padding-top:5px; padding-bottom:5px;">
        <tags:submit formId="reportRevenueForm"
                     ...
                     preAction="reportActiveSubCommDetailAction!reportActiveSubComm.do"/>
    </div>
