<%-- 
    Document   : ReportCreditBook
    Created on : May 13, 2010, 9:57:26 AM
    Author     : Vunt
--%>
...
<tags:imPanel title="MSG.criterion.report.create">
    ...
    <s:form action="reportCreditBookAction" theme="simple" method="post" id="reportRevenueForm">
<s:token/>
        ...
        <div class="divHasBorder" style="margin-top:10px; padding:3px;">
            <%--<s:radio name="reportRevenueForm.reportType" id ="reportType"
                     list="#{'1':'Báo cáo chi tiết vay tín dụng của TK', '2':'Báo cáo danh sách cho vay tín dụng của CH', '3':'Báo cáo nâng cao chi tiết vay tín dụng'}"/>--%>
            <tags:imRadio name="reportRevenueForm.reportType" id="reportType"
                          list="1:MSG.RET.118,2:MSG.RET.119,3:MSG.RET.120"/>
        </div>        
    ...
    <div align="center" style="padding-top:5px; padding-bottom:5px;">
        <tags:submit formId="reportRevenueForm"
                     ...
                     preAction="reportCreditBookAction!reportCreditBook.do"/>
    </div>
