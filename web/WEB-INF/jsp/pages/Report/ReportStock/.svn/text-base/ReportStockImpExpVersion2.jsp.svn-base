...
<s:form method="POST" id="reportStockImpExpForm" action="reportImportExportStockV2Action" theme="simple">
<s:token/>
            ...
            <tr>
                ...
                <td class="text">
                    <%--<s:select name="reportStockImpExpForm.telecomServiceId"
                              ...
                              '%{#request.contextPath}/reportImportExportStockV2Action!selectTelecomService.do')"
                              />--%>
                    <tags:imSelect name="reportStockImpExpForm.telecomServiceId"
                                   ...
                                   listKey="telecomServiceId" listValue="telServiceName"
                                   onchange="updateCombo('reportStockImpExpForm.telecomServiceId','reportStockImpExpForm.stockModelId','${requestScope.contextPath}/reportImportExportStockV2Action!selectTelecomService.do')"
                                   />
                </td>
                ...
                <td class="text">
                    ...
                    <tags:imSelect name="reportStockImpExpForm.stateId"
                                   ...
                                   list="1:MSG.RET.099,2:MSG.RET.100"
                                   />
                </td>
                <td class="label">
            ...
            <tr>
                <td colspan="8" width="100%">
                    <fieldset style="width:100%;">
                        ...
                        <s:hidden name="reportStockImpExpForm.reportDetail" id="reportDetail" value="1"></s:hidden>
                    </fieldset>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="8" align="center" width="100%">
                    <tags:submit id="report" confirm="false" formId="reportStockImpExpForm" showLoadingText="true" validateFunction="validateForm()"
                                 targets="bodyContent" value="MSG.report" preAction="reportImportExportStockV2Action!exportStockImpExpReport.do"/>
                </td>
            </tr>
            <tr>
                <td colspan="8" align="center"  width="100%">
