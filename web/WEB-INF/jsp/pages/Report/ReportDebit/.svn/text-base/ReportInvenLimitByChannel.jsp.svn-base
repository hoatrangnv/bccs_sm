    ...
    <s:form id="inputForm" method="POST" theme="simple">
        <table class="inputTbl6Col">
            <tr>
                ...
                <td class="text">
                    <tags:imSelect name="inputForm.stockType" id="stockType"
            ...
            <tr>
                <td class="label"><tags:label key="lbl.loai.yeu.cau"/></td>
                <td class="text">
                    <tags:imSelect name="inputForm.requestDebitType" id="requestDebitType"
                                   cssClass="txtInputFull" disabled="false"
                                   list="1: MSG.GOD.221, 2: msg.total"
                                   headerKey="" headerValue="lbl.loai.yeu.cau1"/>
                </td>
        ...
        <center>
            <tags:submit formId="inputForm"
                         ...
                         preAction="reportInvenLimitByChannelAction!exportReport.do"/>
        </center>
...
<script type="text/javascript">
    ...
    validateForm = function() {
        ...
        if (jQuery("input[name='dojo.inputForm.fromDate']").val() == "") {
            jQuery("#message").html('<s:property value="getText('err.chua_nhap_ngay_bat_dau_hieu_luc')"/>');
