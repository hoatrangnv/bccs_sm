...
<s:form action="importCompetitorDataAction" theme="simple" method="post" id="channelForm">
    ...
    <tags:imPanel title="importReportData">
        <div>
            <table class="inputTbl4Col">
                <tr>
                    <td colspan="3" align="center">
                        ...
                        <a href="${contextPath}/share/pattern/importCompetitor.xls">${fn:escapeXml(imDef:imGetText('MES.CHL.012'))}</a>
                    </td>
                </tr>
                <tr id="trImpByFile">
                    ...
                    <td class="text">
                        <tags:submit formId="channelForm"
                                     ...
                                     preAction="importCompetitorDataAction!viewFile.do"/>
                    </td>
                </tr>
            </table>
        </div>
        <div id="listStaff">
            <jsp:include page="ImportCompetitorDataList.jsp"/>
        </div>
        <!-- phan nut tac vu -->
        <div align="center" style="padding-top:5px; padding-bottom:5px;">        
            <tags:submit formId="channelForm"
                         ...
                         validateFunction="checkValidFile()"
                         preAction="importCompetitorDataAction!addStaffByFile.do"/>
        </div>
    ...
    <div style="padding-top:10px;">
        <jsp:include page="ImportCompetitorDataSingle.jsp"/>
    </div>
</s:form>
<script type="text/javascript" language="javascript">    
    ...
    <%--$('resultViewChangeStaffInShopClient').innerHTML="Bạn chưa chọn file cần tạo"--%>
                $( 'resultViewChangeStaffInShopClient' ).innerHTML='<s:property escapeJavaScript="true"  value="getText('ERR.CHL.001')"/>';
