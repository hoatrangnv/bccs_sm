...
<%-- 
    Document   : listPoupSearchAgent
    Created on : Dec 1, 2010, 3:41:34 PM
    Author     : vunt
--%>
...
<script>
    ...
    <s:if test="#request.returnType=='shop'">
            document.getElementById("autoCompleteSearchBean").action="CommonStockAction!popupSearchShopUnderlyingAgent.do?shopCode="+code+"&shopName="+name;
