<%-- 
    Document   : addNewBTS
    Created on : Jun 22, 2016, 2:12:29 PM
...
<tags:imPanel title="BTS.BTSPanel.AddNew">
    <!-- hien thi message -->
    <div>
        ...
        <s:form action="manageBTSAction" theme="simple" enctype="multipart/form-data"  method="post" id="btsForm" name="btsForm">
            <table class="inputTbl6Col" style="width:100%" align="center" >
                ...
                <tr>
                    ...
                    <td class="text">
                        <s:textfield name="btsForm.coverType" id="btsForm.coverType" maxlength="20" cssClass="txtInputFull"/>
                    </td>
                </tr>
                <tr>
                    <td class="label">
    ...
    <tags:submit
        ...
        showLoadingText="true" cssStyle="width:85px;" confirm="true"
        value="BTS.btn.AddNew" preAction="manageBTSAction!addNewBTS.do"
        validateFunction="checkValidateAddNew()"
        confirmText="BTS.BTSModel.00001"
        />
    <tags:submit
        targets="bodyContent" formId="btsForm"
